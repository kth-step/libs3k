...
uint64_t s3k_reg_write(s3k_reg_t reg, uint64_t val) {
  sys_args_t args = {.reg_write = {reg, val}};
...
s3k_err_t s3k_try_cap_move(s3k_cidx_t src, s3k_cidx_t dst) {
  sys_args_t args = {.cap_move = {src, dst}};
...
s3k_err_t s3k_try_cap_derive(s3k_cidx_t src, s3k_cidx_t dst, s3k_cap_t ncap) {
  sys_args_t args = {.cap_derive = {src, dst, ncap.raw}};
...
s3k_err_t s3k_try_pmp_load(s3k_cidx_t idx, s3k_pmp_slot_t slot) {
  sys_args_t args = {.pmp_load = {idx, slot}};
...
s3k_err_t s3k_try_mon_suspend(s3k_cidx_t mon, s3k_pid_t pid) {
  sys_args_t args = {.mon_state = {mon, pid}};
...
s3k_err_t s3k_try_mon_state_get(s3k_cidx_t mon, s3k_pid_t pid,
                                s3k_state_t *state) {
  sys_args_t args = {.mon_state = {mon, pid}};
  s3k_ret_t ret = DO_ECALL(S3K_SYS_MON_STATE_GET, args, sizeof(args.mon_state));
  *state = ret.val;
  return ret.err;
}
...
s3k_err_t s3k_try_mon_reg_read(s3k_cidx_t mon, s3k_pid_t pid, s3k_reg_t reg,
                               uint64_t *val) {
  sys_args_t args = {.mon_reg_read = {mon, pid, reg}};
  s3k_ret_t ret =
...
s3k_err_t s3k_try_mon_reg_write(s3k_cidx_t mon, s3k_pid_t pid, s3k_reg_t reg,
                                uint64_t val) {
  sys_args_t args = {.mon_reg_write = {mon, pid, reg, val}};
  s3k_ret_t ret =
...
s3k_err_t s3k_try_mon_cap_read(s3k_cidx_t mon_idx, s3k_pid_t pid,
  ...
  sys_args_t args = {.mon_cap_read = {mon_idx, pid, idx}};
  s3k_ret_t ret =
...
s3k_err_t s3k_try_mon_cap_send(s3k_cidx_t mon_idx, s3k_cidx_t src_idx,
                               s3k_pid_t dst_pid, s3k_cidx_t dst_idx) {
  sys_args_t args = {.mon_cap_send = {mon_idx, src_idx, dst_pid, dst_idx}};
  return DO_ECALL(S3K_SYS_MON_CAP_SEND, args, sizeof(args.mon_cap_send)).err;
}

s3k_err_t s3k_try_mon_pmp_load(s3k_cidx_t mon_idx, s3k_pid_t pid,
                               s3k_cidx_t idx, s3k_pmp_slot_t slot) {
  sys_args_t args = {.mon_pmp_load = {mon_idx, pid, idx, slot}};
  return DO_ECALL(S3K_SYS_MON_PMP_LOAD, args, sizeof(args.mon_pmp_load)).err;
}

s3k_err_t s3k_try_mon_pmp_unload(s3k_cidx_t mon_idx, s3k_pid_t pid,
                                 s3k_cidx_t idx) {
  sys_args_t args = {.mon_pmp_unload = {mon_idx, pid, idx}};
  return DO_ECALL(S3K_SYS_MON_PMP_UNLOAD, args, sizeof(args.mon_pmp_unload))
      .err;
}
...
s3k_reply_t s3k_try_sock_recv(s3k_cidx_t sock_idx, s3k_cidx_t cap_idx) {
  sys_args_t args = {.sock = {.sock_idx = sock_idx, .cap_idx = cap_idx}};
